...
#elif MEM_ALLOCATOR == BEST_FIT

#define MEM_ALLOC_T bfs_mpool_t
#define	K_MEM_INIT(segment, size)	bfs_init ( segment, size )
#define	KMALLOC(size)			bfs_alloc ( k_mpool, size )
#define	KFREE(addr)			bfs_free ( k_mpool, addr )
